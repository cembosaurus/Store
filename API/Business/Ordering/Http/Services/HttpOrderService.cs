...
namespace Business.Ordering.Http.Services
{
    public class HttpOrderService : HttpBaseService, IHttpOrderService
    {
        ...
        public HttpOrderService(IHttpContextAccessor accessor, IWebHostEnvironment env, IExId exId, IHttpAppClient httpAppClient, IGlobalConfig_PROVIDER remoteServices_Provider, IServiceResultFactory resultFact, ConsoleWriter cm)
