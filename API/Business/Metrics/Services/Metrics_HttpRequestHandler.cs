...
public class Metrics_HttpRequestHandler : DelegatingHandler
{
    ...
    public Metrics_HttpRequestHandler(IHttpContextAccessor accessor, IConfiguration config)
    {
    ...
    private void Request_OUT()
    {
        ...
        Console.WriteLine($"XXXXXXXXXXXXXXXXXXXXXXX REQ - out XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX {_index} XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    ...
    private void Response_IN(HttpStatusCode statusCode = HttpStatusCode.ServiceUnavailable)
    {
        ...
        Console.WriteLine($"XXXXXXXXXXXXXXXXXXXXXXX RESP - in XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX {_index} XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
