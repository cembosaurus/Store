...
namespace Business.Inventory.Http.Services
{
    public class HttpCartService : HttpBaseService, IHttpCartService
    {
        ...
        public HttpCartService(IWebHostEnvironment env, IExId exId, IHttpAppClient httpAppClient, IServiceResultFactory resultFact, IGlobalConfig_PROVIDER remoteServices_Provider)
