...
{
    public class HttpAddressService : HttpBaseService, IHttpBaseService, IHttpAddressService
    {


        public HttpAddressService(IHttpContextAccessor accessor, IWebHostEnvironment env, IExId exId, IHttpAppClient httpAppClient, IGlobalConfig_PROVIDER remoteServices_Provider, IServiceResultFactory resultFact, ConsoleWriter cm)
