...
namespace Business.Identity.Http.Services
{
    public class HttpUserService : HttpBaseService, IHttpUserService
    {
        ...
        public HttpUserService(IWebHostEnvironment env, IExId exId, IHttpAppClient httpAppClient, IGlobalConfig_PROVIDER remoteServices_Provider, IServiceResultFactory resultFact) :
