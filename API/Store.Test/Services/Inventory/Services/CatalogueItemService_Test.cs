...
namespace Store.Test.Services.Inventory.Services
{
    ...
    public class CatalogueItemService_Test
    {
        ...
        public void Setup()
        {
            ...
            { 
                ItemId = _catalogueItem1.ItemId, Description = _catalogueItem1.Description, Instock = _catalogueItem1.Instock, Item = _catalogueItem1.Item,
                Accessories = _accessoryItems, SimilarProducts = _similarProductItems
            };
