...
namespace Store.Test.Unit.Tests.Business.Inventory.HTTP.Services
{
    [TestFixture]
    internal class HttpCartService_Test
    {
        ...
        private IGlobalConfig_PROVIDER remoteServices_Provider;
        ...
        [Test]
        [Ignore("Create Cart when success - ignored")]
        ...
        [Test]
        [Ignore("Create Cart when failed - ignored")]
