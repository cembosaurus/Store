...
namespace Store.Test.Unit.Tests.Services.Inventory.Services
{
    ...
    internal class ItemService_Test
    {
        ...
        {
            Name = "Item To Create",
            Description = "Description of Item to create",
            PhotoURL = "Photo URL of Item to create"
        };
        private ItemUpdateDTO _itemToUpdateDTO = new ItemUpdateDTO
        {
            Name = "Item To Update",
            Description = "Description of Item to update",
            PhotoURL = "Photo URL of Item to update"
        };
