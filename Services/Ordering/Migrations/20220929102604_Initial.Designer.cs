...
namespace Ordering.Migrations
{
    ...
    [Migration("20220929102604_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ordering.Models.ActiveCart", b =>
                {
            ...
            modelBuilder.Entity("Ordering.Models.CartItem", b =>
                {
                    b.Property<Guid>("CartId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Ordering.Models.ActiveCart", b =>
                {
                    b.HasOne("Services.Ordering.Models.Cart", "Cart")
                        .WithOne("ActiveCart")
                        .HasForeignKey("Ordering.Models.ActiveCart", "CartId")
