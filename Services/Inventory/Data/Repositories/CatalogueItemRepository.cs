...
namespace Services.Inventory.Data
{
    ...
    public class CatalogueItemRepository : BaseRepository, ICatalogueItemRepository
    {
        ...
        public async Task<EntityEntry> CreateCatalogueItem(CatalogueItem catalogueItem)
        {
            //var result = await _context.CatalogueItems.AddAsync(catalogueItem);

            return await _context.CatalogueItems.AddAsync(catalogueItem); // result.State == EntityState.Added ? true : false;
        }



        public async Task<EntityEntry> RemoveCatalogueItem(CatalogueItem catalogueItem)
        {
            ...
            return _context.CatalogueItems.Remove(catalogueItem); // result.State == EntityState.Deleted ? true: false;
        }
